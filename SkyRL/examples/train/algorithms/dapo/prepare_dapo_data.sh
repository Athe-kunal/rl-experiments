...
# Example: cd SkyRL && bash examples/train/algorithms/dapo/prepare_dapo_data.sh
# Override: DATA_DIR=/path/to/dir bash examples/train/algorithms/dapo/prepare_dapo_data.sh
set -uxo pipefail

export DATA_DIR=${DATA_DIR:-"${PWD}/data/dapo"}
